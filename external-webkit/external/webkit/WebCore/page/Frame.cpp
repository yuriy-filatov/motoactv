...
#include "HTMLCollection.h" // Motorola, E11787, 2009/11/19, IKMAP-2542 / SavePage, Context Menu Enhancement, Browser Shortcut
...
int Frame::getResourceNum(){
    int numResources = 0;

    numResources += document()->images()->length();
    numResources += document()->scripts()->length();
    numResources += document()->CSSs()->length();
    numResources += document()->embeds()->length();
    numResources += document()->objects()->length();
    numResources += document()->miscResources()->length();
