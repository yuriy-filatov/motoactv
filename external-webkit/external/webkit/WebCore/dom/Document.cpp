...
void Document::processMetadataSettings(const String& content)
{
    ...
    while (i < length) {
        ...
        // BEGIN Motorola, w36150, 2010/04/22, IKMAP-8851 / null pointer crash
...
PassRefPtr<HTMLCollection> Document::CSSs()
{
    return HTMLCollection::create(this, DocCSSs);
}

PassRefPtr<HTMLCollection> Document::miscResources()
{
    return HTMLCollection::create(this, DocMiscRes);
}
#endif
// END IKMAP-2542
