...
{   
    ...
    // BEGIN Motorola, W21932, 2010/03/16, IKMAP-7558 / added rounding
    //float nextX = startPoint.x();
    int intNextX = roundf( startPoint.x() );
    float nextX = intNextX;
    ...
    while (nextGlyph < glyphBuffer.size()) {
        ...
        intNextX = nextX;
        intNextX += roundf( glyphBuffer.advanceAt(nextGlyph) );
        nextX = intNextX;
        // END IKMAP-7558
        nextGlyph++;
    }
