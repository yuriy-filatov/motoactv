...
//        throw new UnsupportedOperationException();
    ...
    public void read(final RandomAccessFile file) throws IOException, InvalidTagException {
        ...
        /*optimizations done for podcast reading*/
        // read the data /*Uncomment the below two lines to enable all other TAGs*/
        //this.value = new byte[size];    
        //file.read(this.value);
        file.seek(file.getFilePointer() + size); /*Comment out this line to generalize for other Tags*/
