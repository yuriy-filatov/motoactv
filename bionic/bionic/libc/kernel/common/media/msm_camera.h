// BEGIN MOT FROYO UPMERGE, A22569, 05/19/2010 / Port the delta change
#if defined(CONFIG_MACH_MOT) || defined(CONFIG_MACH_PITTSBURGHA)\
 || defined(CONFIG_MACH_CEINA) || defined (CONFIG_MACH_CALGAY)
#include "msm_camera_k29.h"
#else
// END MOT FROYO UPMERGE
/****************************************************************************
 ****************************************************************************
 ***
...
#endif // MOT FROYO UPMERGE, A22569, 05/19/2010 / Port the delta change
