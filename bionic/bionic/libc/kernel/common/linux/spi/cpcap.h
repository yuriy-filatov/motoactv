...
enum cpcap_reg {
 ...
 CPCAP_REG_END = CPCAP_REG_ST_TEST1,
...
#define CPCAP_IOCTL_GET_RTC_TIME_COUNTER   _IOR(0, CPCAP_IOCTL_NUM_RTC_COUNT, struct cpcap_rtc_time_cnt)

#define CPCAP_IOCTL_TEST_READ_REG   _IOWR(0, CPCAP_IOCTL_NUM_TEST_READ_REG, struct cpcap_regacc*)

#define CPCAP_IOCTL_TEST_SEC_READ_REG   _IOWR(0, CPCAP_IOCTL_NUM_TEST_SEC_READ_REG, struct cpcap_regacc*)

#define CPCAP_IOCTL_TEST_WRITE_REG   _IOWR(0, CPCAP_IOCTL_NUM_TEST_WRITE_REG, struct cpcap_regacc*)

#define CPCAP_IOCTL_TEST_SEC_WRITE_REG   _IOWR(0, CPCAP_IOCTL_NUM_TEST_SEC_WRITE_REG, struct cpcap_regacc*)
...
#define CPCAP_IOCTL_ACCY_WHISPER   _IOW(0, CPCAP_IOCTL_NUM_ACCY_WHISPER, unsigned long)

#define CPCAP_IOCTL_AUDIO_PWR_MODE   _IOW(0, CPCAP_IOCTL_NUM_AUDIO_PWR_MODE, unsigned short)

#define CPCAP_IOCTL_AUDIO_PWR_ENABLE   _IOW(0, CPCAP_IOCTL_NUM_AUDIO_PWR_ENABLE, unsigned short)
