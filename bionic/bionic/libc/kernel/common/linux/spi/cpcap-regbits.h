...
#define CPCAP_BIT_SPARE_12_15 0x00008000
#define CPCAP_BIT_PWRGT2_2SEC 0x00004000
#define CPCAP_BIT_PWRGT1_2SEC 0x00002000
#define CPCAP_BIT_EOL_LOWBP_2SEC 0x00001000
#define CPCAP_BIT_PWRCUT_2SEC 0x00000800
#define CPCAP_BIT_ECHO_2SEC 0x00000400
#define CPCAP_BIT_ADTRIG_PRI_OR_SEC 0x00000200
#define CPCAP_BIT_SECWDIS 0x00000100
#define CPCAP_BIT_SPARE_12_7 0x00000080
#define CPCAP_BIT_SPARE_12_6 0x00000040
#define CPCAP_BIT_CNTLSSI 0x00000020
#define CPCAP_BIT_SPARE_12_4 0x00000010
#define CPCAP_BIT_SPARE_12_3 0x00000008
#define CPCAP_BIT_RTCA_2SEC 0x00000004
#define CPCAP_BIT_SWATCH_2SEC 0x00000002
#define CPCAP_BIT_MAC2PRI 0x00000001

#define CPCAP_BIT_VSDIO_SEL 0x00008000
#define CPCAP_BIT_VDIG_SEL 0x00004000
#define CPCAP_BIT_VCAM_SEL 0x00002000
#define CPCAP_BIT_SW6_SEL 0x00001000
#define CPCAP_BIT_SW5_SEL 0x00000800
#define CPCAP_BIT_SW4_SEL 0x00000400
#define CPCAP_BIT_SW3_SEL 0x00000200
#define CPCAP_BIT_SW2_SEL 0x00000100
#define CPCAP_BIT_SW1_SEL 0x00000080
#define CPCAP_BIT_GPIO6_2SEC 0x00000040
#define CPCAP_BIT_GPIO5_2SEC 0x00000020
#define CPCAP_BIT_GPIO4_2SEC 0x00000010
#define CPCAP_BIT_GPIO3_2SEC 0x00000008
#define CPCAP_BIT_GPIO2_2SEC 0x00000004
#define CPCAP_BIT_GPIO1_2SEC 0x00000002
#define CPCAP_BIT_GPIO0_2SEC 0x00000001

#define CPCAP_BIT_VUSBINT2_SEL 0x00008000
#define CPCAP_BIT_VUSBINT1_SEL 0x00004000
#define CPCAP_BIT_VVIB_SEL 0x00002000
#define CPCAP_BIT_VWLAN1_SEL 0x00001000
#define CPCAP_BIT_VRF1_SEL 0x00000800
#define CPCAP_BIT_VHVIO_SEL 0x00000400
#define CPCAP_BIT_VDAC_SEL 0x00000200
#define CPCAP_BIT_VUSB_SEL 0x00000100
#define CPCAP_BIT_VSIM_SEL 0x00000080
#define CPCAP_BIT_VRFREF_SEL 0x00000040
#define CPCAP_BIT_VPLL_SEL 0x00000020
#define CPCAP_BIT_VFUSE_SEL 0x00000010
#define CPCAP_BIT_VCSI_SEL 0x00000008
#define CPCAP_BIT_SPARE_14_2 0x00000004
#define CPCAP_BIT_VWLAN2_SEL 0x00000002
#define CPCAP_BIT_VRF2_SEL 0x00000001

#define CPCAP_BIT_RX_CODEC_SW_2SEC 0x00008000
#define CPCAP_BIT_RX_VOL_2SEC 0x00004000
#define CPCAP_BIT_RX_OUTPUT_2SEC 0x00002000
#define CPCAP_BIT_TX_MIC_PGA_2SEC 0x00001000
#define CPCAP_BIT_TX_INPUT_2SEC 0x00000800
#define CPCAP_BIT_STEREODAC_DA_2SEC 0x00000400
#define CPCAP_BIT_STEREODAC_2SEC 0x00000200
#define CPCAP_BIT_CODEC_DA_2SEC 0x00000100
#define CPCAP_BIT_CODEC_2SEC 0x00000080
#define CPCAP_BIT_REG_CNTRL2_2SEC 0x00000040
#define CPCAP_BIT_REG_CNTRL1_2SEC 0x00000020
#define CPCAP_BIT_REG_CNTRL_2SEC 0x00000010
#define CPCAP_BIT_32K_ADJ_2SEC 0x00000008
#define CPCAP_BIT_USB_2SEC 0x00000004
#define CPCAP_BIT_ULPI_2SEC 0x00000002
#define CPCAP_BIT_VAUDIO_SEL 0x00000001

#define CPCAP_BIT_BLUETOOTH_2SEC 0x00008000
#define CPCAP_BIT_AB_CONTROL_2SEC 0x00004000
#define CPCAP_BIT_FLASH_2SEC 0x00002000
#define CPCAP_BIT_RGB_BLUE_2SEC 0x00001000
#define CPCAP_BIT_RGB_GREEN_2SEC 0x00000800
#define CPCAP_BIT_RGB_RED_2SEC 0x00000400
#define CPCAP_BIT_AUZ_DISP_BL_2SEC 0x00000200
#define CPCAP_BIT_KEYPAD_BL_2SEC 0x00000100
#define CPCAP_BIT_M_DISP_BL_2SEC 0x00000080
#define CPCAP_BIT_CHARGER_2SEC 0x00000040
#define CPCAP_BIT_MIPI_SLIM2_2SEC 0x00000020
#define CPCAP_BIT_MIPI_SLIM1_2SEC 0x00000010
#define CPCAP_BIT_A2_AMP_2SEC 0x00000008
#define CPCAP_BIT_RX_LOW_LATE_2SEC 0x00000004
#define CPCAP_BIT_RX_PGA_SW_2SEC 0x00000002
#define CPCAP_BIT_RX_STEREO_SW_2SEC 0x00000001

#define CPCAP_BIT_SPARE_17_15 0x00008000
#define CPCAP_BIT_SPARE_17_14 0x00004000
#define CPCAP_BIT_SPARE_17_13 0x00002000
#define CPCAP_BIT_SPARE_17_12 0x00001000
#define CPCAP_BIT_SPARE_17_11 0x00000800
#define CPCAP_BIT_SPARE_17_10 0x00000400
#define CPCAP_BIT_SPARE_17_9 0x00000200
#define CPCAP_BIT_LMMACE_2SEC 0x00000100
#define CPCAP_BIT_LMMISC_2SEC 0x00000080
#define CPCAP_BIT_LMGPIO_2SEC 0x00000040
#define CPCAP_BIT_GCAIMOD_2SEC 0x00000020
#define CPCAP_BIT_GCAICLK_2SEC 0x00000010
#define CPCAP_BIT_OW3_2SEC 0x00000008
#define CPCAP_BIT_OW2_2SEC 0x00000004
#define CPCAP_BIT_OW1_2SEC 0x00000002
#define CPCAP_BIT_CAM_PRIV_2SEC 0x00000001
...
#define CPCAP_BIT_BPEOL_SPARE_137_15 0x00008000
#define CPCAP_BIT_BPEOL_SPARE_137_14 0x00004000
#define CPCAP_BIT_BPEOL_SPARE_137_13 0x00002000
#define CPCAP_BIT_BPEOL_SPARE_137_12 0x00001000
#define CPCAP_BIT_BPEOL_SPARE_137_11 0x00000800
#define CPCAP_BIT_BPEOL_SPARE_137_10 0x00000400
#define CPCAP_BIT_BPEOL_SPARE_137_09 0x00000200
#define CPCAP_BIT_BPEOL_REGSEL1 0x00000100
#define CPCAP_BIT_BPEOL_REGSEL0 0x00000080
#define CPCAP_BIT_BPEOL_LOWBP1 0x00000040
#define CPCAP_BIT_BPEOL_LOWBP0 0x00000020
#define CPCAP_BIT_BPEOL_EOLSEL2 0x00000010
#define CPCAP_BIT_BPEOL_EOLSEL1 0x00000008
#define CPCAP_BIT_BPEOL_EOLSEL0 0x00000004
#define CPCAP_BIT_BPEOL_LOWBPEN 0x00000002
#define CPCAP_BIT_BPEOL_LOWBP_EOLSEL 0x00000001
...
#define CPCAP_BIT_SEC_UNUSED_266_15 0x00008000
#define CPCAP_BIT_SEC_UNUSED_266_14 0x00004000
#define CPCAP_BIT_SEC_UNUSED_266_13 0x00002000
#define CPCAP_BIT_SEC_UNUSED_266_12 0x00001000
#define CPCAP_BIT_SEC_UNUSED_266_11 0x00000800
#define CPCAP_BIT_SEC_UNUSED_266_10 0x00000400
#define CPCAP_BIT_SEC_UNUSED_266_9 0x00000200
#define CPCAP_BIT_SEC_UNUSED_266_8 0x00000100
#define CPCAP_BIT_SEC_UNUSED_266_7 0x00000080
#define CPCAP_BIT_SEC_UNUSED_266_6 0x00000040
#define CPCAP_BIT_SEC_UNUSED_266_5 0x00000020
#define CPCAP_BIT_SEC_UNUSED_266_4 0x00000010
#define CPCAP_BIT_SEC_UNUSED_266_3 0x00000008
#define CPCAP_BIT_SEC_UNUSED_266_2 0x00000004
#define CPCAP_BIT_SEC_UNUSED_266_1 0x00000002
#define CPCAP_BIT_SEC_HOST_SUSPENDED 0x00000001
