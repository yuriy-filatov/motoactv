...
/*[[Moto_Change_Begin jtnr47 Increase PA_COUNT_MAX from 247 to 311 since it reaches max in Ruth*/
/* (8 header words + 311 toc words) = 1276 bytes */
/* 1280 bytes header and toc + 311 prop_infos @ 128 bytes = 41088 bytes */
