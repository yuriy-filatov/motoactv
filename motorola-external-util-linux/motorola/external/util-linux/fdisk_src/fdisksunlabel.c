...
static inline unsigned short sun__swap16(unsigned short x) {
        return (((__u16)(x) & 0xFF) << 8) | (((__u16)(x) & 0xFF00) >> 8);
}
static inline __u32 sun__swap32(__u32 x) {
        return (((__u32)(x) & 0xFF) << 24) | (((__u32)(x) & 0xFF00) << 8) | (((__u32)(x) & 0xFF0000) >> 8) | (((__u32)(x) & 0xFF000000) >> 24);
}

#define SSWAP16(x) (other_endian ? sun__swap16(x) \
				 : (__u16)(x))
#define SSWAP32(x) (other_endian ? sun__swap32(x) \
				 : (__u32)(x))
