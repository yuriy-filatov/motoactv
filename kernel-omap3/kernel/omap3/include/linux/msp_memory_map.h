...
#define SLEEP_DATA                                      0x8A
#define SLEEP_ANALYSIS_ON                               0x8B
...
#define GPS_CAL_TABLE                                   0xBB
#define ERASE_CAL                                       0xDB
#define MSP_RESET_DETECT                                0xDC
/*to revisit these address when their features are implemented in MSP */
#define USER_CAL_TABLE                                  0xDD
#define WORKOUT_MSP_DIST                                0xE7
#define WORKOUT_USER_DIST                               0xEB
#define ACTV_TIMER					0xF0 /* 4 bytes */
#define GESTURE_TYPE					0xF4
#define GESTURE_MASK					0xF5
...
#define M_SLEEP_DATA_READY             0x80
...
#define ERASE_CAL_VAL                 0xAA


#define M_RAW_ECOMPASS_DATA_BUFFER     0x80

#define GESTURE_TYPE_TAP		0x01
#define GESTURE_TYPE_SCREEN_ON		0x02
