...
#ifdef CONFIG_MACH_MAPPHONE
	l3_div = cm_read_mod_reg(CORE_MOD, CM_CLKSEL) & OMAP3430_CLKSEL_L3_MASK;
	/* Some devices boot at 200MHz, some at 166MHz.  Handle accordingly */
	mapphone_set_l3_opp2_rate(rate/l3_div);
#endif
