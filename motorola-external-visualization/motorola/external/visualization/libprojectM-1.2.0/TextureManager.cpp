...
void TextureManager::Preload()
{
	...
	GLuint tex = ilutGLBindTexImage();
	 ...
	 GLuint tex = SOIL_load_OGL_texture_from_memory(
					  M_data,
					  M_bytes,
					  SOIL_LOAD_RGB /*SOIL_LOAD_AUTO*/,
					  SOIL_CREATE_NEW_ID,
				  
					    SOIL_FLAG_POWER_OF_TWO	       
					  /*|   SOIL_FLAG_MULTIPLY_ALPHA
					  |  SOIL_FLAG_COMPRESS_TO_DXT	ProjectM_Android*/    
					  );
#endif

  PROJECTM_LOG_DEBUG("TextureManager::Preload M.tga %d",tex);
  textures["M.tga"]=tex;
  ...
  PROJECTM_LOG_DEBUG("TextureManager::Preload project.tga %d",tex);
  ...
  PROJECTM_LOG_DEBUG("TextureManager::Preload headphones.tga %d",tex);
